...
(function($, window, document, undefined) {
    ...
    var iMethods = {
        ...
        eventHandler: function(e) {
            ...
            menu.find('.iw-mSelected').removeClass('iw-mSelected').addClass('iw-mnotSelected');
        ...
        selectMenu: function(menu, elm) {
            ...
            selected.removeClass('iw-mSelected').addClass('iw-mnotSelected');
            elm.addClass('iw-mSelected').removeClass('iw-mnotSelected');
        },
            ...
            if ((typeof selector == 'object') && (!selector.nodeType) && (!selector.jquery)) {
                ...
                $.each(selector, function(index, selObj) {
                    var name = selObj.name,
                        ...
                        title = selObj.title || "",
                        color = selObj.color || "",
                        className = selObj.className || "iw-mnotSelected",
                        disable = selObj.disable,
                        list = $('<li title="' + title + '" class="' + className + '" style="color: ' + color + ';">' + name + '</li>');

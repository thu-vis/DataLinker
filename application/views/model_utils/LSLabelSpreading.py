...
class BaseLabelPropagation(BaseEstimator, ClassifierMixin, metaclass=ABCMeta):
   ...
   n_jobs : int or None, optional (default=None)
    ...
    def fit(self, X, y):
        ...
        t2 = time()
        print("building graph time cost: {}, spreading time cost: {}"
              .format(t1-t0, t2-t1))

        return self


class LSLabelSpreading(BaseLabelPropagation):
    _variant = 'spreading'
    ...
    def _build_graph(self):
        ...
        if self.graph_matrix is not None:
            print("using pre-built graph")
